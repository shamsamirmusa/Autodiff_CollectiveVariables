...
plumedInit = {
   "COMPONENTS": {
        "Writhe": {"period": None, "derivative": True}
   }}
@jit
...
writhe_grade_fn = jit(grad(compute_writhe_simplex)) 
...
#     writhe_gradient = writhe_grade_fn(x)
#     return writhe_value, writhe_gradient, zero_box_derivative
